...
export function StoreProvider({ children }) {
    ...
    async function getContactList() {
        ...
        try {
            const response = await fetch("https://playground.4geeks.com/contact/agendas/yoalvarado/contacts/", requestOptions);
    ...
    async function createUser() {
        ...
        try {
            const response = await fetch("https://playground.4geeks.com/contact/agendas/yoalvarado", requestOptions);
        } catch (error) {
            console.error(error);
        }
    }
    ...
    async function deleteContact(id) {
        ...
        try {
            const response = await fetch(`https://playground.4geeks.com/contact/agendas/yoalvarado/contacts/${id}`, requestOptions)
        } catch (error) {
            console.error(error);
        };
    }
